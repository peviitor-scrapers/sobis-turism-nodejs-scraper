...
| Field        | Type     | Description |
|--------------|----------|-------------|
| brand        | string   | Commercial brand name (e.g. "SOBIS") |
| group        | string   | Parent company group (e.g. "SOBIS") |
...
- **scraperFile**: Full URL to the GitHub Actions workflow (no raw, e.g. `https://github.com/peviitor-scrapers/sobis-turism-nodejs-scraper/actions/workflows/job-seeker-ro-spider.yml`)