...
const baseCompany = {
  ...
  career: ["https://www.sobisturism.ro"],
  lastScraped: "2026-08-05"
};

const baseJob = {
  url: "https://www.sobisturism.ro/en/vacancy/123_en",
...
describe("generateJobsMarkdown", () => {
  ...
  describe("jobs section", () => {
    ...
    it("includes job URL as markdown link", () => {
      const md = generateJobsMarkdown(baseCompany, [baseJob]);
      expect(md).toContain("[https://www.sobisturism.ro/en/vacancy/123_en]");
    });
    ...
    it("renders multiple jobs", () => {
      const job2 = { ...baseJob, title: "DevOps Engineer", url: "https://www.sobisturism.ro/en/vacancy/456_en" };
    ...
    it("handles job with no optional fields", () => {
      const minimal = { url: "https://www.sobisturism.ro/en/vacancy/999_en", title: "QA Engineer" };
